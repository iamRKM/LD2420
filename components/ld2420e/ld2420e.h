...
namespace esphome
{
  namespace ld2420e
  {
    ...
    static const uint8_t LD2420E_ERROR_NONE = 0x00;
    static const uint8_t LD2420E_ERROR_TIMEOUT = 0x02;
    static const uint8_t LD2420E_ERROR_UNKNOWN = 0x01;
    static const uint8_t LD2420E_TOTAL_GATES = 16;
    ...
    static const uint16_t CMD_GATE_MOVE_THRESH[LD2420E_TOTAL_GATES] = {0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015,
                                                                       0x0016, 0x0017, 0x0018, 0x0019, 0x001A, 0x001B,
                                                                       0x001C, 0x001D, 0x001E, 0x001F};
    static const uint16_t CMD_GATE_STILL_THRESH[LD2420E_TOTAL_GATES] = {0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025,
                                                                        0x0026, 0x0027, 0x0028, 0x0029, 0x002A, 0x002B,
                                                                        0x002C, 0x002D, 0x002E, 0x002F};
    static const uint32_t FACTORY_MOVE_THRESH[LD2420E_TOTAL_GATES] = {60000, 30000, 400, 250, 250, 250, 250, 250,
                                                                      250, 250, 250, 250, 250, 250, 250, 250};
    static const uint32_t FACTORY_STILL_THRESH[LD2420E_TOTAL_GATES] = {40000, 20000, 200, 200, 200, 200, 200, 150,
    ...
    class LD2420EComponent : public Component, public uart::UARTDevice
    {
    public:
      void setup() override;
...
#endif
      void register_listener(LD2420EListener *listener) { this->listeners_.push_back(listener); }
      ...
      struct RegConfigT
      {
        ...
        uint16_t max_gate{0};
        uint16_t timeout{0};
        uint32_t move_thresh[LD2420E_TOTAL_GATES];
        uint32_t still_thresh[LD2420E_TOTAL_GATES];
      };
      ...
      uint16_t radar_data[LD2420E_TOTAL_GATES][CALIBRATE_SAMPLES];
      uint16_t gate_avg[LD2420E_TOTAL_GATES];
      uint16_t gate_peak[LD2420E_TOTAL_GATES];
